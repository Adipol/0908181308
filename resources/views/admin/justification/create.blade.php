        ...
        <div class="row">
            <div class="col-12 col-sm-8 offset-sm-2">
                <div class="card">
                    ...
                    <form method="post" action="{{ route('justification.store') }}">
                        {{csrf_field()}}
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="" class="col-md-4 col-form-label">Nombre</label>
                                <div class="col-md-8">
                                <input type="text" name="name" class="form-control" placeholder="Ingrese la justificación" value="{{ old('name') }}" required="required" autofocus>
                                </div>
                            </div>
                        </div>
