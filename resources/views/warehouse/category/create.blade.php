    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-8 offset-md-2">
                <div class="card">
                    <h3 class="card-header font-weight-bold text-primary bg-secondary text-white-50">Nueva Categoria</h3>
                    <div>
                        @if (count($errors)>0)
                    ...
                    <form method="post" action="{{ route('category.store') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                    <textarea name="description" cols="30" class="form-control" rows="5" placeholder="Ingrese la descripcion">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                        </div>
