...
class UnityUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
			'name'         => 'required|min:3|max:25|unique:units,name,'.$this->id,
			'abbreviation' => 'required|min:1|max:10|unique:units,abbreviation,'.$this->id
        ];
    }
